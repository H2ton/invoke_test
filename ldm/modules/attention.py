...
_USE_MEMORY_EFFICIENT_ATTENTION = True #int(os.environ.get("USE_MEMORY_EFFICIENT_ATTENTION", 0)) == 1
class BasicTransformerBlock(nn.Module):
    r"""
    ...
    def __init__(
        ...
        super().__init__()
        AttentionBuilder = MemoryEfficientCrossAttention if checkXformers and _USE_MEMORY_EFFICIENT_ATTENTION else CrossAttention
